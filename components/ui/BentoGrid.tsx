...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("mikis011@hotmail.com");
    setCopied(true);
  };
  return (
    <div
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-1">
              <div className="flex flex-col gap-3 md:gap-2 lg:gap-3 mt-3">
                {["React", "Next.js", "TailwindCSS", "TypeScript"].map(
                  (item) => (
                    <span
                      key={item}
              ...
              <div className="flex flex-col gap-3 md:gap-2 lg:gap-3 mt-3">
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132E]" />
                {["MongoDB", "Express", "Figma"].map((item) => (
                  <span
                    key={item}
                    className="lg:py-3 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 
                    lg:opacity-100 rounded-lg text-center bg-[#10132E]"
