...
const Approach = () => {
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4" id="approach">
        <Card
          title="Planning & Stratergy"
          icon={<AceternityIcon order="Phase 1" />}
          description="I plan and strategize the project with the webiste goals, target audince, and key functionalities in mind."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="Once I have gotten feedback and it's agreed on, I cue my playlist and dive into coding. From initial sketches from Figma to polished code, I keep everyone updated in every step of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="This is where the magic happens! Based on the agreed desgin, I'll translate it into functional code, building the website from the ground up."
        >
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center
       dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl md:h-[30rem] md:mb-10"
    >
